function tooexpensiveremoved:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    ...
    '{"text": "Removes Too Expensive from anvils", "color": "#aaaaaa"}',\
    '""',\
    '[{"text": "Datapack version: ", "color": "#00a800"}, {"text": "v.1.1.1", "color": "#54fc54"}]',\
